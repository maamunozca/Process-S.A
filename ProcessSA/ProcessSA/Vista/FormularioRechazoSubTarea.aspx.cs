...
{
    public partial class FormularioRechazoSubTarea : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("FormularioSubTareasFuncionario.aspx?parametro=" + IDTRANSFERIDO.Text + "&parametro2=" + EmailTransferido.Text);
        }
