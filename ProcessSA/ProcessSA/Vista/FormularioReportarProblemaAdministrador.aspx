<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormularioReportarProblemaAdministrador.aspx.cs" Inherits="ProcessSA.Vista.FormularioReportarProblemaAdministrador" %>
                                ...
                                <div class="col-xs-12">
                                    <div class="ContenidoAgregar">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br />
                                        <asp:Button ID="BtnBuscar" CssClass="btn btn-info btn-lg" runat="server" Text="Buscar Problema Tarea" OnClick="BtnBuscar_Click" />
                                             <br />
                                        </div>                                       
                                        <!--GridView--> 
                                        <div class="row">
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="contenidoTabla">
                                                        <div class="table-responsive">                                        
                                                            <asp:GridView ID="GridReportarProblema" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Width="100%">
                                                                ...
                                                                <Columns>
                                                                    <asp:BoundField ItemStyle-Width="15%" HeaderText="ID Problema" DataField="ID_PROBLEMA"/>
                                                                    <asp:BoundField ItemStyle-Width="15%" HeaderText="ID Tarea" DataField="ID_TAREA"/>
                                                                    <asp:BoundField ItemStyle-Width="15%" HeaderText="Fecha Emision" DataField="FECHA PROBLEMA"/>
                                                                    <asp:BoundField ItemStyle-Width="55%" HeaderText="Descripcion Problema" DataField="DESCRIPCION_PROBLEMA"/>
                                                                </Columns>
                                        ...
                                        <div >
                                            ...
                                            <asp:Label ID="Alerta" runat="server" Text="Debe Ingresar El Problema Que Tuvo Con La Tarea "></asp:Label>               
